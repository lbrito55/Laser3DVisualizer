...
import { FreeCamera, ArcRotateCamera, Vector3, PointerEventTypes, Engine, Scene, HemisphericLight, DirectionalLight, ShadowGenerator, MeshBuilder, TransformNode, Color3, Space, AbstractMesh, SceneLoader, BoundingInfo, VRExperienceHelper, Mesh, CubeTexture, Texture, StandardMaterial } from 'babylonjs';
import { GUI3DManager, CylinderPanel, HolographicButton, Button3D, Image, TextBlock, StackPanel, Control, InputText, Rectangle, AdvancedDynamicTexture, Button, VirtualKeyboard } from 'babylonjs-gui';
...
var SceneComponent = /** @class */ (function (_super) {
    ...
    SceneComponent.prototype.render = function () {
        ...
        var children = React.Children.map(this.props.children, function (child, index) { return React.cloneElement(child, {
...
var FreeCamera$1 = /** @class */ (function (_super) {
    __extends$1(FreeCamera$$1, _super);
    function FreeCamera$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    FreeCamera$$1.prototype.componentsCreated = function () {
        /* ignored */
    };
    Object.defineProperty(FreeCamera$$1.prototype, "camera", {
        get: function () {
            return this._camera;
        },
        enumerable: true,
    ...
    Object.defineProperty(FreeCamera$$1.prototype, "noPreventDefault", {
        get: function () {
    ...
    FreeCamera$$1.prototype.create = function (scene) {
        var position;
        if (this.props.position !== undefined) {
            position = this.props.position;
        }
        else {
            position = new Vector3(this.props.x ? this.props.x : 0, this.props.y ? this.props.y : 0, this.props.z ? this.props.z : 0);
        }
        this._camera = new FreeCamera(this.props.name, position, this.props.scene, this.props.setActiveOnSceneIfNoneActive);
        return this._camera;
    };
    Object.defineProperty(FreeCamera$$1.prototype, "propsHandlers", {
        get: function () {
    ...
    FreeCamera$$1.prototype.componentWillReceiveProps = function () {
...
var ArcRotateCamera$1 = /** @class */ (function (_super) {
    __extends$2(ArcRotateCamera$$1, _super);
    function ArcRotateCamera$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(ArcRotateCamera$$1.prototype, "camera", {
        get: function () {
            return this._camera;
        },
        enumerable: true,
    ...
    Object.defineProperty(ArcRotateCamera$$1.prototype, "noPreventDefault", {
        get: function () {
            return this.props.noPreventDefault === true;
        },
        enumerable: true,
    ...
    ArcRotateCamera$$1.prototype.componentsCreated = function () {
        /* ignored */
    };
    ArcRotateCamera$$1.prototype.create = function (scene) {
        ...
        this._camera = new ArcRotateCamera(this.props.name, this.props.alpha || -(Math.PI / 2), this.props.beta || Math.PI / 2, radius, target, scene, this.props.setActiveOnSceneIfNoneActive);
    ...
    Object.defineProperty(ArcRotateCamera$$1.prototype, "propsHandlers", {
        get: function () {
            return [new CameraPropsHandler()];
        },
        enumerable: true,
...
var Scene$1 = /** @class */ (function (_super) {
    __extends$3(Scene$$1, _super);
    function Scene$$1(props) {
    ...
    Scene$$1.prototype.componentDidUpdate = function () {
        if (this.firstDidUpdate === false) {
            this.firstDidUpdate = true;
        }
    };
    Scene$$1.prototype.componentDidMount = function () {
        var _this = this;
    ...
    Scene$$1.prototype.componentWillUnmount = function () {
    ...
    Scene$$1.prototype.onRegisterChild = function (child) {
        if (child instanceof FreeCamera$1 || child instanceof ArcRotateCamera$1) {
    ...
    Scene$$1.prototype.render = function () {
        var _this = this;
        ...
        return (React.createElement("canvas", __assign({}, opts, { ref: this.onCanvas3d }), children));
    };
    return Scene$$1;
}(Component));
...
var HemisphericLight$1 = /** @class */ (function (_super) {
    __extends$4(HemisphericLight$$1, _super);
    function HemisphericLight$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    HemisphericLight$$1.prototype.componentsCreated = function () {
        /* ignored */
    };
    HemisphericLight$$1.prototype.create = function (scene) {
        var direction;
        if (this.props.direction !== undefined) {
            direction = this.props.direction;
        }
        else {
            direction = new Vector3(this.props.x ? this.props.x : 0, this.props.y ? this.props.y : 0, this.props.z ? this.props.z : 0);
        }
        this.light = new HemisphericLight(this.props.name, direction, scene);
        return this.light;
    };
    Object.defineProperty(HemisphericLight$$1.prototype, "propsHandlers", {
        get: function () {
...
var DirectionalLight$1 = /** @class */ (function (_super) {
    __extends$5(DirectionalLight$$1, _super);
    function DirectionalLight$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(DirectionalLight$$1.prototype, "light", {
        get: function () {
            return this._light;
        },
        enumerable: true,
    ...
    DirectionalLight$$1.prototype.create = function (scene) {
        var direction;
        if (this.props.direction !== undefined) {
            direction = this.props.direction;
        }
        ...
        this._light = new DirectionalLight(this.props.name, direction, scene);
        return this._light;
    };
    DirectionalLight$$1.prototype.componentsCreated = function () {
        /* ignore */
    };
    Object.defineProperty(DirectionalLight$$1.prototype, "propsHandlers", {
        get: function () {
            return [new LightPropsHandler()];
        },
        enumerable: true,
...
var ShadowGenerator$1 = /** @class */ (function (_super) {
    __extends$6(ShadowGenerator$$1, _super);
    function ShadowGenerator$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ShadowGenerator$$1.prototype.create = function (scene) {
        var container = this.props.container;
        if (container instanceof DirectionalLight$1) {
            // console.log("Creating a shadow generater for directional light:", container.light)
            if (container.light) {
                this.shadowGenerator = new ShadowGenerator(this.props.mapSize, container.light);
            }
        }
        else {
    ...
    ShadowGenerator$$1.prototype.componentsCreated = function () {
        var _this = this;
    ...
    Object.defineProperty(ShadowGenerator$$1.prototype, "propsHandlers", {
        get: function () {
            return [];
        },
        enumerable: true,
...
var Box = /** @class */ (function (_super) {
    ...
    Box.prototype.create = function (scene) {
        this.box = MeshBuilder.CreateBox(this.props.name ? this.props.name : "", this.options, scene);
 ...
 */
var GUI3DManager$1 = /** @class */ (function (_super) {
    __extends$d(GUI3DManager$$1, _super);
    function GUI3DManager$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    GUI3DManager$$1.prototype.create = function (scene) {
        this.gui3dManager = new GUI3DManager(scene);
        return this.gui3dManager;
    };
    GUI3DManager$$1.prototype.addControl = function (control) {
        this.gui3dManager.addControl(control);
    };
    GUI3DManager$$1.prototype.removeControl = function (control) {
        this.gui3dManager.removeControl(control);
    };
    GUI3DManager$$1.prototype.componentsCreated = function () {
        // not used
    };
    Object.defineProperty(GUI3DManager$$1.prototype, "propsHandlers", {
        get: function () {
            return [];
        },
        enumerable: true,
 ...
 *
 */
var CylinderPanel$1 = /** @class */ (function (_super) {
    __extends$e(CylinderPanel$$1, _super);
    function CylinderPanel$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CylinderPanel$$1.prototype.addControl = function (control) {
        // console.log("adding control to cylinder panel:", control)
        this.cylinderPanel.addControl(control);
    };
    CylinderPanel$$1.prototype.removeControl = function (control) {
        // console.log("removing control to cylinder panel:", control)
        this.cylinderPanel.removeControl(control);
    };
    CylinderPanel$$1.prototype.componentsCreated = function () {
        // not used
    };
    CylinderPanel$$1.prototype.componentWillUnmount = function () {
        this.props.container.removeControl(this.cylinderPanel);
    };
    CylinderPanel$$1.prototype.create = function (scene) {
        this.cylinderPanel = new CylinderPanel();
     ...
     */
    CylinderPanel$$1.prototype.initComplete = function (cylinderPanel) {
    ...
    Object.defineProperty(CylinderPanel$$1.prototype, "propsHandlers", {
        get: function () {
 ...
 *
 */
var HolographicButton$1 = /** @class */ (function (_super) {
    __extends$f(HolographicButton$$1, _super);
    function HolographicButton$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    HolographicButton$$1.prototype.addControl = function (control) {
        console.log("not implemented adding controls to holographic button");
    };
    HolographicButton$$1.prototype.removeControl = function (control) {
        throw new Error("Method not implemented.");
    };
    HolographicButton$$1.prototype.componentsCreated = function () {
        // not used
    };
    HolographicButton$$1.prototype.componentWillUnmount = function () {
        this.props.container.removeControl(this.holographicButton);
    };
    HolographicButton$$1.prototype.create = function (scene) {
        var _this = this;
        this.holographicButton = new HolographicButton(this.props.name);
    ...
    Object.defineProperty(HolographicButton$$1.prototype, "propsHandlers", {
        get: function () {
            return [];
        },
        enumerable: true,
 ...
 *
 */
var Button3D$1 = /** @class */ (function (_super) {
    __extends$g(Button3D$$1, _super);
    function Button3D$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Button3D$$1.prototype.addControl = function (control) {
        console.warn("not implemented adding controls to Button3D (it uses content)");
    };
    Button3D$$1.prototype.removeControl = function (control) {
        throw new Error("Method not implemented.");
    };
    Button3D$$1.prototype.componentsCreated = function () {
        // not used
    };
    Button3D$$1.prototype.componentWillUnmount = function () {
     ...
     */
    Button3D$$1.prototype.initComplete = function (button3D) {
        var _this = this;
        ...
        if (this.props.hoverEmmissiveColor) {
            if (button3D.mesh) {
                ...
                button3D.pointerOutAnimation = function () {
                    material_1.emissiveColor = Color3.Black();
                };
            }
        }
    };
    Button3D$$1.prototype.create = function (scene) {
        var _this = this;
        this.button3D = new Button3D(this.props.name);
        // console.log("created button", this.props.name)
        var text = undefined;
        var image = undefined;
        if (this.props.imageUrl) {
            image = new Image(this.props.name + "-image", this.props.imageUrl);
        }
        if (this.props.text) {
            text = new TextBlock();
    ...
    Object.defineProperty(Button3D$$1.prototype, "propsHandlers", {
        get: function () {
            return [];
        },
        enumerable: true,
 ...
 * Cannot be attached directly to a 3D panel.
 */
var InputText$1 = /** @class */ (function (_super) {
    __extends$j(InputText$$1, _super);
    function InputText$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    InputText$$1.prototype.componentsCreated = function () {
        // not used
    };
    InputText$$1.prototype.addControl = function (control) {
        throw new Error("Method not implemented.");
    };
    InputText$$1.prototype.removeControl = function (control) {
        throw new Error("Method not implemented.");
    };
    InputText$$1.prototype.create = function (scene) {
        this.inputText = new InputText(this.props.name, this.props.text);
    ...
    Object.defineProperty(InputText$$1.prototype, "propsHandlers", {
        get: function () {
...
var StackPanel$1 = /** @class */ (function (_super) {
    __extends$k(StackPanel$$1, _super);
    function StackPanel$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    StackPanel$$1.prototype.create = function (scene) {
        this.stackPanel = new StackPanel(this.props.name);
        if (this.props.isVertical !== undefined) {
            this.stackPanel.isVertical = this.props.isVertical;
        }
        return this.stackPanel;
    };
    StackPanel$$1.prototype.addControl = function (control) {
        this.stackPanel.addControl(control);
    };
    StackPanel$$1.prototype.removeControl = function (control) {
        this.stackPanel.removeControl(control);
    };
    StackPanel$$1.prototype.componentsCreated = function () {
        /* ignore */
    };
    Object.defineProperty(StackPanel$$1.prototype, "propsHandlers", {
        get: function () {
...
var Rectangle$1 = /** @class */ (function (_super) {
    __extends$l(Rectangle$$1, _super);
    function Rectangle$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Rectangle$$1.prototype.addControl = function (control) {
        this.rectangle.addControl(control);
    };
    Rectangle$$1.prototype.removeControl = function (control) {
        this.rectangle.removeControl(control);
    };
    Rectangle$$1.prototype.create = function (scene) {
        this.rectangle = new Rectangle(this.props.name);
        return this.rectangle;
    };
    Rectangle$$1.prototype.componentsCreated = function () {
        /* ignore */
    };
    Object.defineProperty(Rectangle$$1.prototype, "propsHandlers", {
        get: function () {
 ...
 */
var AdvancedDynamicTexture$1 = /** @class */ (function (_super) {
    __extends$m(AdvancedDynamicTexture$$1, _super);
    function AdvancedDynamicTexture$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AdvancedDynamicTexture$$1.prototype.addControl = function (control) {
        this.advancedDynamicTexture.addControl(control);
    };
    AdvancedDynamicTexture$$1.prototype.removeControl = function (control) {
        this.advancedDynamicTexture.removeControl(control);
    };
    AdvancedDynamicTexture$$1.prototype.componentWillReceiveProps = function () {
        // not implemented for StackPanel
    };
    AdvancedDynamicTexture$$1.prototype.create = function (scene) {
        this.advancedDynamicTexture =
            this.props.createForParentMesh === true
                ? AdvancedDynamicTexture.CreateForMesh(this.props.container.babylonObject, this.props.width, this.props.height, this.props.supportPointerMove, this.props.onlyAlphaTesting)
                : new AdvancedDynamicTexture(this.props.name, this.props.width, this.props.height, scene, this.props.generateMipMaps, this.props.samplingMode);
        return this.advancedDynamicTexture;
    };
    AdvancedDynamicTexture$$1.prototype.componentsCreated = function () {
        /* ignore */
    };
    Object.defineProperty(AdvancedDynamicTexture$$1.prototype, "propsHandlers", {
        get: function () {
            return [
    ...
    return AdvancedDynamicTexture$$1;
}(GUI2DSceneComponent));
...
var Button$1 = /** @class */ (function (_super) {
    __extends$n(Button$$1, _super);
    function Button$$1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Button$$1.prototype.componentsCreated = function () {
        // not used
    };
    Button$$1.prototype.addControl = function (control) {
        this.button.addControl(control);
    };
    Button$$1.prototype.removeControl = function (control) {
        this.button.removeControl(control);
    };
    Button$$1.prototype.create = function (scene) {
        this.button = new Button(this.props.name);
    ...
    Object.defineProperty(Button$$1.prototype, "propsHandlers", {
        get: function () {
            return [new ContainerPropsHandler(), new ControlPropsHandler(), new RectanglePropsHandler()];
        },
        enumerable: true,
 ...
 * Cannot be attached directly to a 3D panel.
 */
var VirtualKeyboard$1 = /** @class */ (function (_super) {
    __extends$o(VirtualKeyboard$$1, _super);
    function VirtualKeyboard$$1() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.keyboardConnected = false;
        return _this;
    }
    VirtualKeyboard$$1.prototype.componentsCreated = function () {
        var _this = this;
            ...
            if (this.props.controlNames) {
                this.props.controlNames.forEach(function (controlName) {
                    ...
                    if (control === undefined) {
                        ...
                        if (control instanceof InputText$1) {
    ...
    VirtualKeyboard$$1.prototype.addControl = function (control) {
        throw new Error("Method not implemented.");
    };
    VirtualKeyboard$$1.prototype.removeControl = function (control) {
        throw new Error("Method not implemented.");
    };
    VirtualKeyboard$$1.prototype.create = function (scene) {
        this.virtualKeyboard = VirtualKeyboard.CreateDefaultLayout();
        return this.virtualKeyboard;
    };
    Object.defineProperty(VirtualKeyboard$$1.prototype, "propsHandlers", {
        get: function () {
            return [new ContainerPropsHandler(), new ControlPropsHandler()];
        },
        enumerable: true,
...
var Model = /** @class */ (function (_super) {
    ...
    Model.prototype.create = function (scene) {
        ...
        var loader = SceneLoader.ImportMesh(undefined, this.props.rootUrl, this.props.sceneFilename, scene, function (meshes, particleSystems, skeletons, animationGroups) {
            loadedModel.rootMesh = new AbstractMesh(_this.props.sceneFilename + "-model");
...
var StandardMaterial$1 = /** @class */ (function (_super) {
    __extends$u(StandardMaterial$$1, _super);
    function StandardMaterial$$1(props) {
        var _this = _super.call(this, props) || this;
    ...
    StandardMaterial$$1.prototype.apply = function (target, scene) {
        var standardMaterial = new StandardMaterial(this.props.name, scene);
    ...
    StandardMaterial$$1.prototype.render = function () {
    ...
    return StandardMaterial$$1;
}(Component));

export { Scene$1 as Scene, HemisphericLight$1 as HemisphericLight, DirectionalLight$1 as DirectionalLight, ShadowGenerator$1 as ShadowGenerator, Box, Sphere, Box$1 as IcoSphere, Plane, Ground, GUI3DSceneComponent, GUI3DManager$1 as GUI3DManager, CylinderPanel$1 as CylinderPanel, HolographicButton$1 as HolographicButton, Button3D$1 as Button3D, GUI2DSceneComponent, Text, InputText$1 as InputText, StackPanel$1 as StackPanel, Rectangle$1 as Rectangle, AdvancedDynamicTexture$1 as AdvancedDynamicTexture, Button$1 as Button, VirtualKeyboard$1 as VirtualKeyboard, FreeCamera$1 as FreeCamera, ArcRotateCamera$1 as ArcRotateCamera, CameraPropsHandler, RotateMeshBehaviour as RotateMeshBehavior, Model, LoadedModel, LoaderStatus, VRExperience, Environment, Skybox, StandardMaterial$1 as StandardMaterial };
